    ...
    function putInArticle(data) {
        ...
        var articleFooter = $('<div class="end-logo">' +
            ...
            '<img src="img/site/weixin.jpg">' +
            '</p>' +
            '<p class="show-weixin-pic">欢迎关注我们的微信公众号：易科机器人实验室</p>' +
        ...
        $('.other').append($('<div class="social-share" data-initialized="true" data-url="http://www.exbot.net:23452/findArticle?articleId=' + data.articleId + '&originalAuthor='+ data.originalAuthor + '"  data-title="' + data.articleTitle + '">' +
