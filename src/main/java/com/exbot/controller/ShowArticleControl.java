...
public class ShowArticleControl {
    ...
    * @return
    */
    @PostMapping("/getArticleTitleByArticleIdAndOriginalAuthor")
    public @ResponseBody JSONObject getArticleTitleByArticleIdAndOriginalAuthor(@RequestParam("articleId") String articleId,
                                                                    @RequestParam("originalAuthor") String originalAuthor){
        ...
        JSONObject jsonObject = JSONObject.fromObject(articleMap);
        return jsonObject;
    }
